...
const HeroSection2 = ({ className }: HeroSection2Props) => {
  return (
    <div className={className}>
      <div className="flex min-h-[calc(100vh-5rem)] flex-col justify-between bg-[#F5F5DC] sm:flex-row">
        <div className="flex-3/5 self-end py-16 pr-6 pl-container xl:pb-20">
          <div className="max-w-2xl">
            ...
            <Heading fontSize="text-5xl/none md:text-6xl/none lg:text-7xl/none font-semibold" className="mt-8">
              <span data-slot="italic">To</span> Lift, to Rise, to <span data-slot="italic">Elevate.</span>
            </Heading>
            <Text className="mt-8 max-w-sm">
              Born from Passion, Tailored for Perfection - Levioosa is where comfort meets luxury
            </Text>
            <Button
