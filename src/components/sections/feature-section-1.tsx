...
const FeatureSection1 = ({
  className,
  description = "Discover a world where comfort meets confidence. Every Levioosa piece is designed with precision, merging timeless aesthetics and modern silhouettes — crafted to elevate your every moment. Experience effortless style and unparalleled comfort, season after season.",
